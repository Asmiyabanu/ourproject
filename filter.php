...
echo '<li class="page-item"><a class="page-link" href="filter?Location='.$Location.'&City='.$City.'&Category='.$Category.'&SCategory='.$SCategory.'&status='.$status.'&page=' . ($page - 1) . '"> <span>&#10094; Previous</span></a></li>';
 ...
 echo"<li class='page-item'><a class='page-link' class='$class' href='filter.php?Location=$Location&City=$City&Category=$Category&SCategory=$SCategory&status=$status&page=$i'><div class='$class'>$i</div></a></li>";
  }
...
if (($number_of_page - ($page + 1)) > 0) {
    ...
    echo"<li class='page-item'><a class='page-link' href='filter.php?Location=$Location&City=$City&Category=$Category&SCategory=$SCategory&status=$status&page=$number_of_page'> <div class='$class'>$number_of_page</div> </div></a></li>";
  }
...
echo '<li class="page-item"><a class="page-link" href="filter.php?Location='.$Location.'&City='.$City.'&Category='.$Category.'&SCategory='.$SCategory.'&status='.$status.'&page=' . ($page + 1) . '"> Next &#10095;</span></a></li>';
